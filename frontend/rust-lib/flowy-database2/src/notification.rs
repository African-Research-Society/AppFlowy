...
impl std::convert::From<i32> for DatabaseNotification {
  fn from(notification: i32) -> Self {
    match notification {
      ...
      81 => DatabaseNotification::DidUpdateDatabaseLayout,
      82 => DatabaseNotification::DidDeleteDatabaseView,
      83 => DatabaseNotification::DidMoveDatabaseViewToTrash,
      84 => DatabaseNotification::DidUpdateDatabaseSyncUpdate,
      85 => DatabaseNotification::DidUpdateDatabaseSnapshotState,
